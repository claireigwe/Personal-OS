    ...
    <main className="flex min-h-dvh items-center justify-center px-5 py-10">
      <section className="w-full max-w-sm rounded-2xl border border-white/20 dark:border-white/[0.08] bg-white/60 dark:bg-white/[0.04] backdrop-blur-xl shadow-xl shadow-black/5 p-6">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-normal">Start calmly</h1>
          <p className="mt-2 text-sm text-muted-foreground">Create your workspace for daily focus and pronunciation-first Dutch.</p>
        </div>
